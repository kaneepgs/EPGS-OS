  ...
  ceo: {
    ...
    businessHealthScore: {
      ...
      modules: CEO_DATA.businessHealthScore.modules.map((item) => {
        ...
        if (item.module === 'Operations') return { ...item, score: Math.round(INTELLIGENCE.health.ceo.components.operationsDelivery || item.score), summary: `Generated by HealthEngine: operations delivery now reflects schedule capacity, visible fitting demand, and scheduling risk from the Operations Calendar.` };
        return item;
      })
    }
  },
